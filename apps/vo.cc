...
int main(int argc, char** argv)
{
  ...
  options
      ("config,c", "/home/zju/Desktop/bpvo-master/conf/tsukuba.cfg", "config file")
  ...
  //-->voapp.c  Voapp inital: viewer setting,initial _vo,config file read

  vo_app.run();
  //-->voapp.c start thread:mainloop
